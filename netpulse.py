...
class NetPulse:
    ...
    def ping(self, host: str, count: int = 4, continuous: bool = False, callback=None) -> dict:
        try:
    ...
    def nslookup(self, domain: str) -> dict:
        try:
            ...
            return {"domain": domain, "hostname": hostname, "aliases": aliases, "addresses": addresses}
        except Exception as e:
